...
saima = User.create(name: "Saima Akhtar", about: "Architect turned SEI Student", interests: "Buildings and Design", username: "sja")
injae = User.create(name: "Injae Lee", about: "Entrepreneur turned SEI Student", interests: "Ocean and Coding", username: "ilee")
