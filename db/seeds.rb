...
#posts
p1 = Post.create(title: "That Discomfort You're Feeling is Grief", description: "Interesting take on grief and the current moment", media_link: 'https://hbr.org/2020/03/that-discomfort-youre-feeling-is-grief', user: u1)
